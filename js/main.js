            ...
            if(datapro[i].category.includes(value.toLowerCase() ) ) {
                ...
                `
                        <tr>
                             ...
                             <td>${datapro[i].count}</td>
                             <td>${datapro[i].category}</td>
                             <td><button styel="notPrint" type="button" onclick="update(${i})" class="btn btn-outline-primary" id="update">update</button></td>
                             <td><button styel="notPrint" type="button" onclick="deletitem(${i})" class="btn btn-outline-danger" id="dlt">delete</button></td>
                         </tr>
                 `
            }
        }
